...
button2.addEventListener().remove();
...
function update(location) {
  ...
  picture.style.backgroundImage = location.image;
...
function attack() {
  ...
  if (isMonsterHit()) {
    ...
    document.body.style.backgroundColor = "rgb(132, 11, 11)";
    document.body.style.transition = "backgroundColor 1s linear";
